...
const Services = () => {
 useEffect(() => {
  ...
  return (
    <>
      <div className="Services mx-4 h-full grid grid-cols-1 gap-8 md:mx-0 md:grid-cols-2 md:justify-between md:items-center md:px-28 md:py-12 ">
        <p
          className="leading-loose text-lightFontText dark:text-darkFontText"
          data-Aos="zoom-in-up"
        >
