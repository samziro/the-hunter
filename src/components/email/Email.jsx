...
const Email = () => {
    return (
        <div className='email h-[70dvh] mx-4 md:mx-0 bg-slate-50 dark:bg-darkCardTheme rounded-lg shadow-sm p-6 flex flex-col md:grid grid-cols-2 gap-4 md:gap-8 justify-center items-center ' >
