...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <h1 className=" text-4xl leading-loose md:text-8xl cursor-pointer text-lightFontText z-10 font-extrabold mb-4">
        ...
        <h3 className="text-darkFontHeading z-10 text-3xl font-bold my-2">TRUST THE PROCESS AND TRANSFORM YOUR LIFE.</h3>
