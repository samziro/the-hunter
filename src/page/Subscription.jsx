                ...
                <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    <div className="order-1 md:order-2">
                        <div  className="relative">
                            <img alt="Fitness Transformation" className="w-full shadow-2xl object-cover object-top" src={trainer} />
                    ...
                    <div className="order-1">
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 shadow-xl p-8 ">
                            <div className="mb-8 text-lightFontHeading dark:text-lightFontText">
                            ...
                            <div className="mb-8">
                                <h6 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Selected Plan</h6>
                                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex-1">
                                            <h5 className="font-bold text-gray-900 dark:text-white">Ultimate Transformation Workout &amp; Meal Plan - $39</h5>
                            ...
                            <div>
                                <h5 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Enter Registration Details</h5>
                                <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg">
                                    <p className="text-red-800 dark:text-red-400 text-sm">Registration failed. Please try again.</p>
                                </div>
                                <form id="subscription-form"  className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input id="firstName" placeholder="First Name" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="text"  />
                                        </div>
                                        <div>
                                            <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Last Name</label>
                                            <input id="lastName" placeholder="Last Name" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="text"  />
                                        </div>
                                    </div>
                                    <div>
                                        <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email Address</label>
                                        <input id="email" placeholder="Email Address" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="text"  />
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label htmlFor="country" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Country</label>
                                            <input id="country" placeholder="Country" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="text"  />
                                        </div>
                                        <div>
                                            <label htmlFor="region" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Region</label>
                                            <input id="region" placeholder="Region" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="text"  /></div>
                                    </div>
                                    <div>
                                        <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Password</label>
                                        <div className="relative">
                                            <input id="password" placeholder="Password" required="" className="w-full px-4 py-3 border border-yellow-200 dark:border-yellow-700 rounded-lg bg-white dark:bg-yellow-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm" type="password"  />
