...
const Hero = () => {
  return (
    ...
    >
      <motion.div
        className="hero-content backdrop-brightness-50 backdrop-blur-sm m-4 grid grid-cols-1 justify-items-center align-items-center md:text-center md:px-28 md:w-3/4 "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
