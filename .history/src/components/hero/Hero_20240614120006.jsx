...
const Hero = () => {
  return (
    ...
    >
      <motion.div
        className="hero-content sm:m-4 grid grid-cols-1 justify-items-center align-items-center text-center md:px-28 md:w-3/4 "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 1, duration: 2 }}
      >
        <h1 className=" md:text-6xl cursor-pointer text-stone-600 font-semibold mb-4">
          The Fit Hunter
        </h1>
