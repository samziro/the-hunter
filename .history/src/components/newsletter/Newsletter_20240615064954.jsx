      ...
      <div className="mx-4 md:px-28 md:1/2 md:grid md:grid-cols-1 md:place-items-center md:m-0">
        ...
        <div className="icons flex justify-center align-center gap-4 ">
          <a href="https://www.facebook.com/hunterkalama">
            <img src='../../assets/facebook-svgrepo-com.svg' alt="facebook" className="w-8 h-8" />
          </a>
          <a href="https://www.instagram.com/the.fit.hunter/?hl=en">
            <img src='../../assets/instagram-svgrepo-com (1).svg' alt="instagram" className="w-8 h-8" />
          </a>
          <a href="https://www.youtube.com/@the.fit.hunter">
            <img src='../../assets/youtube-168-svgrepo-com.svg' alt="youtube" className="w-8 h-8" />
          </a>
          <a href="https://wa.me/0748679264">
            <img src='../../assets/phone-call-ringing-svgrepo-com.svg' alt="phone_call" className="w-8 h-8" />
          </a>
          <a href="tel:0748679264">
            <img src='../../assets/whatsapp-fill-svgrepo-com.svg' alt="whatsapp" className="w-8 h-8" />
          </a>
        </div>
      </div>
      <hr className="my-2" />
