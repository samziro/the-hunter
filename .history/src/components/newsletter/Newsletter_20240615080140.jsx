    ...
    <>
      <div className="mx-4 md:px-28 md:1/2 md:grid md:grid-cols-1 md:place-items-center md:m-0">
        ...
        <div className="grid grid-cols-1">
          ...
          />
          <button className="py-1 px-4 mt-1 rounded-lg text-slate-100 bg-neutral-700 hover:bg-neutral-900 ">
            Subscribe
          </button>
        </div>
        <div className="icons flex justify-center align-center gap-4 mt-8">
          ...
          <a href="https://www.youtube.com/@the.fit.hunter" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faYoutube} className='text-stone-700 hover:text-stone-900 w-8 h-8'/>
          </a>
          ...
          <a href="tel:0748679264">
            <FontAwesomeIcon icon={faPhoneAlt} className='text-stone-700 hover:text-stone-900 w-6 h-6'/>
          </a>
        </div>
      </div>
      <hr className="my-2" />
