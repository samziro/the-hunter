        ...
        >
          ...
          <form onSubmit={onSubmit} className="md:w-1/2">
            ...
            <div>
              <button
                type="submit"
                className="py-1 px-4 w-full md:w-1/2 rounded-lg text-slate-100 bg-neutral-700 hover:bg-neutral-900 "
              >
                Send Message
              </button>
            </div>
          </form>
          <span className="mt-8 font-semibold text-stone-600 text-left">{result}</span>
        </div>
      </div>
    </>
  );
