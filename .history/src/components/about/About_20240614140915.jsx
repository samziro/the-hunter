...
const About = () => {
  ...
  return (
    <>
      ...
      <motion.div className="values mx-4 md:mx-0 grid grid-cols-1 gap-4 md:grid md:grid-cols-3 md:justify-items-center md:align-items-center md:gap-8 md:px-28">
        {cardData.map((item) => (
          <motion.div
            key={item.heading}
