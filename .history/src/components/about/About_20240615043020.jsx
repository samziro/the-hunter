...
const About = () => {
  ...
  return (
    <>
      <div className="About mx-4 h-full grid grid-cols-1 gap-8 md:mx-0 md:flex md:justify-between md:items-center md:px-28 md:py-12 ">
        <img src={about_image} alt="about-me-image" data-Aos="zoom-in-up" className='' />
        <p
