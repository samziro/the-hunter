...
const Classes = () => {
  ...
  useEffect(() => {
    Aos.init({duration:00});
  }, [])
  return (
    <div>
      <div className="values h-full mx-4 md:mx-0 grid grid-cols-1 gap-4 md:grid md:grid-cols-4 md:justify-items-center md:align-items-center md:gap-4 md:px-28 py-8">
        {classData.map((item) => (
          <div
            key={item.heading}
