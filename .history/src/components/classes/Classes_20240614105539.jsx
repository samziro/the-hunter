...
const Classes = () => {
  ...
  return (
    <>
      <div className="values h-full grid grid-cols-1 gap-4 md:grid md:grid-cols-4 md:justify-items-center md:align-items-center md:gap-4 md:px-28 py-8">
        {classData.map((item) => (
          <div key={item.heading} className="shadow-lg rounded-lg p-2"  ref={ref}
          style={{
            scale: scaleProgress,
