...
const Navbar = () => {
  return (
    ...
    >
      <div className="logo">
        <Link to="Hero" smooth={true} offset={0} duration={500}><h1 className="text-2xl cursor-pointer font-semibold md:pt-1">
          Hunter's World
        </h1>
          </Link >
      </div>
      ...
      <div className="join-btn font-medium">
        <Link to="Contact" smooth={true} offset={-120} duration={500}></Link><button className="hidden md:block py-2 px-4 rounded-lg text-slate-100 bg-neutral-700 hover:bg-neutral-900">
          Contact Us
        </button>
      </div>
    </motion.div>
