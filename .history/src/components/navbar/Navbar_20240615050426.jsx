...
const Navbar = () => {
  return (
    <motion.div
      className="z-50 fixed w-full bg-white text-stone-600 py-3 md:px-28 flex md:justify-between md:align-center md:py-2 shadow"
      initial={{ y: -250 }}
      animate={{ y: 0 }}
    ...
    >
      ...
      <img className="w-8 md:hidden md:opacity-0" src={bars} alt="bars" />
