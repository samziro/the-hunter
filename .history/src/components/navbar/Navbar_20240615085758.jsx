...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="links">
        <ul className="{mobileMenu ? '': 'hide_menu'} hidden cursor-pointer font-medium md:flex md:justify-between md:align-center md:gap-8 md:pt-2">
        ...
        <div className="mobileMenu -mr-52 hidden">
          <ul className="md:hidden ">
            <button className="-mr-10 flex justify-end" onClick={toggleMenu}>
        ...
        <div className="-mr-10 flex justify-end" onClick={toggleMenu}>
          <FontAwesomeIcon icon={faBars} className="w-4 h-5" />
        </div>
      </div>
