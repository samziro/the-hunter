...
const Testimonials = () => {
  ...
  return (
    <>
      <div className="Testimonialh-full mx-4 md:mx-0 grid grid-cols-1 gap-4 md:grid md:grid-cols-3 md:justify-items-center md:align-items-center md:gap-4 md:px-28 py-8">
