...
const Testimonials = () => {
  ...
  const ref = useRef(null);
   ...
   const opacityProgress = useTransform(scrollYProgress, [0.2, 1], [0.6, 1]);
  return (
    <>
      <div className="values h-full g">
        <div className="rid grid-cols-1 gap-4 md:grid md:grid-cols-3 md:justify-items-center md:align-items-center md:gap-4 md:px-28 py-8">
